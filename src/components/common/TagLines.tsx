...
const TagLines = ({ children,className }: { children: React.ReactNode,className?:string }) => {
  return (
    <div className={`relative inline-block px-4 py-2.5 rounded-[103px]  bg-white/10 backdrop-blur-[2px] text-white text-sm font-medium mb-6 animate-fade-in-down overflow-hidden ${className}`}>
