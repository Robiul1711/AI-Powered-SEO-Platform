...
export const ServiceIcon = ({ className }: { className?: string }) => {
    return (
<svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M21.285 6.42C21.0069 6.15198 20.6362 6.00154 20.25 6H15.75V4.5C15.75 4.10218 15.592 3.72064 15.3107 3.43934C15.0294 3.15804 14.6478 3 14.25 3H9.75C9.35218 3 8.97065 3.15804 8.68934 3.43934C8.40804 3.72064 8.25 4.10218 8.25 4.5V6H3.75C3.35755 5.99966 2.9806 6.15313 2.7 6.4275C2.55737 6.56731 2.44409 6.73419 2.36682 6.91836C2.28955 7.10253 2.24983 7.30028 2.25 7.5V19.5C2.25 19.8978 2.40804 20.2794 2.68934 20.5607C2.97064 20.842 3.35218 21 3.75 21H20.25C20.6478 21 21.0294 20.842 21.3107 20.5607C21.592 20.2794 21.75 19.8978 21.75 19.5V7.5C21.7492 7.29794 21.7076 7.09812 21.6277 6.91254C21.5478 6.72695 21.4313 6.55942 21.285 6.42ZM6.75 14.25C8.32317 15.2371 10.1428 15.7607 12 15.7607C13.8572 15.7607 15.6768 15.2371 17.25 14.25V19.5H6.75V14.25ZM12 14.25C10.0063 14.2492 8.0773 13.5424 6.555 12.255L6.4425 12.1575C5.05745 10.9793 4.18362 9.3096 4.005 7.5H19.9725C19.65 11.25 16.1325 14.25 12 14.25ZM9.75 4.5H14.25V6H9.75V4.5ZM3.75 11.25C4.16887 11.92 4.6731 12.5326 5.25 13.0725V19.5H3.75V11.25ZM18.75 19.5V13.0725C19.3254 12.5312 19.8295 11.9188 20.25 11.25V19.5H18.75Z" fill="currentColor"/>
</svg>
    )
}
...
<svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  <path d="M14 2V7C14 7.26522 14.1054 7.51957 14.2929 7.70711C14.4804 7.89464 14.7348 8 15 8H20" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
export const ProgressIcon = ({ className }: { className?: string }) => {
    return (
<svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M11 6H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M11 12H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M11 18H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
