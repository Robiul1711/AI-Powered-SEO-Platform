    ...
    <div className="relative w-full section-padding-x section-padding-y overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center mx-auto py-10 sm:py-12 md:py-16 lg:py-20">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <CommonButton to="/ai-seo-audit" as="link" className="bg-white text-Primary!  px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base shadow-[0_0_30px_rgba(172,108,255,0.4)]">
            Start Free AI Audit
          </CommonButton>
          <CommonButton
            as="link"
