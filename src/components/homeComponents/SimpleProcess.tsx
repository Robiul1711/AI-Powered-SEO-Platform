...
const SimpleProcess = () => {
  const steps = [
    ...
    },
    {
      ...
      icon: <AiStars />,
      title: "AI SEO Audit",
      desc: "Deep automated analysis",
    },
    {
      id: "03",
      icon: <Proposal />,
      title: "Get Proposal",
      desc: "Receive custom strategy",
    },
    {
      id: "04",
      icon: <Payment />,
      title: "Make Payment",
      desc: "Securely start process",
    },
    {
      id: "05",
      icon: <Dashboard />,
      title: "Dashboard",
      desc: "Access your SEO hub",
    },
    {
      id: "06",
      icon: <Reports />,
      title: "Get Reports",
      desc: "Detailed growth insights",
    },
  ];
    ...
    <div className="section-padding-x section-padding-y">
      <div className="flex flex-col items-center gap-4 font-inter">
        ...
        <p className="text-base sm:text-lg text-white/60 mb-10 max-w-2xl text-center font-inter">
          From audit to ongoing optimization—our AI handles the complexity while
          you see results
        </p>
      </div>
