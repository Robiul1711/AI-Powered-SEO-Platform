        ...
        {services.length > 0 ? (
          services.map((service, sIdx) => (
            <div
              ...
              className="bg-[#1A1A1A] border border-white/5 rounded-3xl sm:rounded-[2.5rem] p-5 sm:p-10 relative overflow-hidden"
            >
              {/* Subtle top gradient line */}
              <div className="absolute top-0 left-0 w-full h-px bg-linear-to-r from-transparent via-[#AC6CFF]/30 to-transparent" />
              
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div className="flex items-center gap-4">
                    <div className="w-1.5 h-10 bg-linear-to-b from-[#AC6CFF] to-[#6C9AFF] rounded-full shadow-[0_0_10px_rgba(172,108,255,0.4)]" />
                    <div>
